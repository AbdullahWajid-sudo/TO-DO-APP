...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4 mt-10 ">
        ...
        <div className="bg-surface-container-lowest rounded-xl p-8 shadow-sm border border-outline-variant/20">
          ...
          <div className="mt-6">
            ...
            <button
              ...
              className="mt-4 w-full bg-surface-container-high text-on-surface font-medium py-3 px-4 rounded-lg hover:bg-surface-container-highest focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 transition-colors flex items-center justify-center gap-2"
            >
