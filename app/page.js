        ...
        <header className="mb-8 px-6 md:ml-20 md:px-0">
          ...
          <div className="flex flex-wrap gap-4 items-center">
            <button
              ...
              className="bg-primary text-white px-4 py-1.5 rounded-full text-[0.6875rem] font-bold tracking-widest uppercase hover:opacity-90 transition-opacity flex items-center gap-2"
            >
        ...
        <section className="max-w-6xl mx-auto">
          ...
          <div className="relative max-w-md mb-6">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-xl focus:ring-2 focus:ring-brand-shopify outline-none transition-all"
            />
            {searchTerm && (
              <button
